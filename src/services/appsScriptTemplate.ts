/**
 * Google Apps Script - Base de Données NemApi (Users, Licenses, Subscriptions, UsageLogs)
 * 
 * À coller dans Extensions > Apps Script de votre Google Sheet
 * Déploiement : Déployer > Nouveau déploiement > Type: Application Web > Exécuter en tant que: Moi > Accès: Tout le monde
 */
 ...
 */
function ensureStructure(ss, forceSeed = false) {
...
/**
 * Données de départ pour les tests
 */
...
/**
 * Convertit une feuille Google Sheet en tableau d'objets JSON
 */
...
/**
 * Recherche d'un utilisateur par ID ou email
 */
...
/**
 * Création d'une clé de licence dans le Sheet
 */
...
/**
 * Activation et assignation d'une licence à un utilisateur
 */
...
/**
 * Récupère toutes les licences rattachées à un utilisateur
 */
...
/**
 * Enregistrement d'un log de consommation
 */
